...
Download Software V0.12 for Raspberry Pi 3 and 4 (AAC Codec implemented)
https://bwsyncandshare.kit.edu/s/dm6EnfwaExpejkd?path=%2FRamplify%2FRamplify%20v0.12

Download Software V0.13 for Raspberry Pi Zero (At the moment no AAC Codec implemented)
